...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, PresenceUpdatedEvent> presenceConsumerFactory() {
        JsonDeserializer<PresenceUpdatedEvent> deserializer =
                new JsonDeserializer<>(PresenceUpdatedEvent.class, false);
    ...
    public ConsumerFactory<String, UserDeletedEvent> userDeletedConsumerFactory() {
        ...
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "chat-service-delete-group");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PresenceUpdatedEvent>
    presenceKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PresenceUpdatedEvent> factory =
